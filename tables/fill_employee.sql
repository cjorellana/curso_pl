DECLARE 
  first_names VARCHAR2(32767) := 'John,Mary,Steve,Emily,Robert,Karen,Paul,Emma,David,Linda';
  last_names VARCHAR2(32767) := 'Smith,Johnson,Williams,Brown,Jones,Miller,Davis,Garcia,Rodriguez,Wilson';
